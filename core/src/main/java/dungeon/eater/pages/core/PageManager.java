package dungeon.eater.pages.core;
...
import dungeon.eater.events.page.PageClosedEvent;
import dungeon.eater.events.page.PageOpenedEvent;
...
public class PageManager implements Disposable {
    ...
    public void show (Class<? extends APage> clazz) {
        final Cell<APage> pageCell = API.get(UIScreen.class).getMainPageCell();
