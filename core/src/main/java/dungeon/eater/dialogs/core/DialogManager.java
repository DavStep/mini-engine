package dungeon.eater.dialogs.core;
...
import dungeon.eater.events.dialog.DialogClosedEvent;
import dungeon.eater.events.dialog.DialogOpenedEvent;
...
public class DialogManager implements Disposable {
    ...
    public void show (Class<? extends ADialog> clazz) {
        ...
        API.get(UIScreen.class).getRootUI().addActor(dialog);
